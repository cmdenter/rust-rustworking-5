...
export type backend_config = { 'worker' : null } |
  { 'ollama' : null } |
...
export interface chat_response_v1 { 'message' : assistant_message }
export interface config {
  'workers_whitelist' : { 'all' : null } |
...
export interface tool_call_argument { 'value' : string, 'name' : string }
